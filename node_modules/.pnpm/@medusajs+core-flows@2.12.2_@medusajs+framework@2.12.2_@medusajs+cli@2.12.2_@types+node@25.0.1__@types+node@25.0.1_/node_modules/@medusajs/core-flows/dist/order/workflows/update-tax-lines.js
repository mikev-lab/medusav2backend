...
exports.updateOrderTaxLinesWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.updateOrderTaxLinesWorkflowId, (input) => {
    ...
    const items = (0, workflows_sdk_1.when)("get-order-line-items", { input }, ({ input }) => {
        return input.item_ids?.length > 0;
    }).then(() => {
        const { data: orderLineItems } = (0, common_1.useQueryGraphStep)({
    ...
    const shippingMethods = (0, workflows_sdk_1.when)("get-order-shipping-methods", { input }, ({ input }) => {
        return input.shipping_method_ids?.length > 0;
    }).then(() => {
        const { data: orderShippingMethods } = (0, common_1.useQueryGraphStep)({
