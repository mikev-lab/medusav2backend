 ...
 */
export declare const updateOrderTaxLinesWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateOrderTaxLinesWorkflowInput, {
    itemTaxLines: (import("@medusajs/framework/types").ItemTaxLineDTO[] | WorkflowData<import("@medusajs/framework/types").ItemTaxLineDTO[]>) & import("@medusajs/framework/types").ItemTaxLineDTO[];
    shippingTaxLines: (import("@medusajs/framework/types").ShippingTaxLineDTO[] | WorkflowData<import("@medusajs/framework/types").ShippingTaxLineDTO[]>) & import("@medusajs/framework/types").ShippingTaxLineDTO[];
}, []>;
