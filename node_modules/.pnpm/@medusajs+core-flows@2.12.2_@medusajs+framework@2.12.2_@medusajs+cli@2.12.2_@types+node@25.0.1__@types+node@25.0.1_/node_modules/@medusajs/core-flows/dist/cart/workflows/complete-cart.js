...
const acquire_lock_1 = require("../../locking/steps/acquire-lock");
const release_lock_1 = require("../../locking/steps/release-lock");
...
exports.completeCartWorkflow = (0, workflows_sdk_1.createWorkflow)({
    ...
    const [orderCart, cartData] = (0, workflows_sdk_1.parallelize)((0, common_1.useQueryGraphStep)({
        entity: "order_cart",
    ...
    const paymentSessions = (0, steps_1.validateCartPaymentsStep)({ cart: cartData.data });
    ...
    const order = (0, workflows_sdk_1.when)("create-order", { orderId }, ({ orderId }) => {
        ...
        const cartOptionIds = (0, workflows_sdk_1.transform)({ cart: cartData.data }, ({ cart }) => {
            return cart.shipping_methods?.map((sm) => sm.shipping_option_id);
        });
        const shippingOptionsData = (0, common_1.useQueryGraphStep)({
        ...
        (0, steps_1.validateShippingStep)({
            cart: cartData.data,
            shippingOptions: shippingOptionsData.data,
        });
        const { variants, sales_channel_id } = (0, workflows_sdk_1.transform)({ cart: cartData.data }, (data) => {
            const variantsMap = {};
        ...
        const cartToOrder = (0, workflows_sdk_1.transform)({ cart: cartData.data }, ({ cart }) => {
        ...
        const updateCompletedAt = (0, workflows_sdk_1.transform)({ cart: cartData.data }, ({ cart }) => {
            return {
                id: cart.id,
                completed_at: new Date(),
            };
        });
        const promotionUsage = (0, workflows_sdk_1.transform)({ cart: cartData.data }, ({ cart }) => {
        ...
        const linksToCreate = (0, workflows_sdk_1.transform)({ cart: cartData.data, createdOrder }, ({ cart, createdOrder }) => {
            const links = [
                {
