...
exports.createCartWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.createCartWorkflowId, (input) => {
    ...
    const { variants, lineItems } = get_variants_and_items_with_prices_1.getVariantsAndItemsWithPrices.runAsStep({
        input: {
            cart: {
    ...
    const itemsToCreate = (0, workflows_sdk_1.transform)({ lineItems }, (data) => {
        return data.lineItems.map((i) => i.data);
    });
    const translatedItems = (0, steps_1.getTranslatedLineItemsStep)({
        items: itemsToCreate,
        variants,
        locale: input.locale,
    });
    const cartToCreate = (0, workflows_sdk_1.transform)({ cartInput, translatedItems }, (data) => {
        data.cartInput.items = data.translatedItems;
        return data.cartInput;
    });
