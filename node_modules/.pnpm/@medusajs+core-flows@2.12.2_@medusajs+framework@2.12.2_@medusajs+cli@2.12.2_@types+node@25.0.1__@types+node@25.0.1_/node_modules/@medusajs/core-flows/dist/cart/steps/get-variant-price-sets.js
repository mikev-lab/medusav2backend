 ...
 */
async function processVariantPriceSets(pricingService, items, container) {
    const result = {};
...
exports.getVariantPriceSetsStep = (0, workflows_sdk_1.createStep)(exports.getVariantPriceSetsStepId, async (data, { container }) => {
    ...
    const result = await processVariantPriceSets(pricingModuleService, calculationItems, container);
