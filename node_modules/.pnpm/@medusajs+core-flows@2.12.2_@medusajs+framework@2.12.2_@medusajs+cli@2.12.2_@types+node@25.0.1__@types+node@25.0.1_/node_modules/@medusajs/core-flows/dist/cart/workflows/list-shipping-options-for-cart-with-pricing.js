...
exports.listShippingOptionsForCartWithPricingWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.listShippingOptionsForCartWithPricingWorkflowId, (input) => {
    ...
    const setShippingOptionsContext = (0, workflows_sdk_1.createHook)("setShippingOptionsContext", {
        cart: cart,
        fulfillmentSetIds,
        additional_data: input.additional_data,
    }, {
        resultValidator: schemas_1.shippingOptionsContextResult,
    });
    const setShippingOptionsContextResult = setShippingOptionsContext.getResult();
    const commonOptions = (0, workflows_sdk_1.transform)({
        input,
        cart,
        fulfillmentSetIds,
        optionIds,
        setShippingOptionsContextResult,
    }, ({ input, cart, fulfillmentSetIds, optionIds, setShippingOptionsContextResult, }) => ({
        context: (0, utils_1.QueryContext)({
            ...(setShippingOptionsContextResult
                ? setShippingOptionsContextResult
                : {}),
     ...
     */
    const { data: initialOptions } = (0, common_1.useQueryGraphStep)({
    ...
    return new workflows_sdk_1.WorkflowResponse(shippingOptionsWithPrice, {
        hooks: [setShippingOptionsContext],
    });
});
