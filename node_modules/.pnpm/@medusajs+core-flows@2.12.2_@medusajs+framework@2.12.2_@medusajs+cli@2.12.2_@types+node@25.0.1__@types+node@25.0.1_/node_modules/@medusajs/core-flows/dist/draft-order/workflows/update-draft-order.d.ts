import { OrderDTO, UpdateOrderDTO, UpsertOrderAddressDTO } from "@medusajs/framework/types";
 ...
 */
export declare const updateDraftOrderWorkflow: import("@medusajs/framework/workflows-sdk").ReturnWorkflow<UpdateDraftOrderWorkflowInput, import("@medusajs/framework/types").OrderPreviewDTO, []>;
