...
export type ModuleExports<T = Constructor<any>> = {
    ...
    runMigrations?(options: LoaderOptions<any>, moduleDeclaration?: InternalModuleDeclaration): Promise<{
        name: string;
        path: string;
    }[]>;
    revertMigration?(options: LoaderOptions<any>, moduleDeclaration?: InternalModuleDeclaration, migrationNames?: string[]): Promise<void>;
