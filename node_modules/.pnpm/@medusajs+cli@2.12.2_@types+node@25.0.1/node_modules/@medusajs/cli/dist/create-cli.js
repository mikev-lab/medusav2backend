    ...
    cli
        ...
        builder: (builder) => {
            ...
            builder.option("all-or-nothing", {
                type: "boolean",
                describe: "If set, the command will fail if any migration fails and revert the migrations that were applied so far",
                default: false,
            });
        },
        ...
        builder: (_) => _.option("types", {
            ...
            .option(`cluster`, {
            type: `string`,
            describe: "Start the Node.js server in cluster mode. Specify the number of CPUs to use or a percentage (e.g., 50%). Defaults to the number of available CPUs.",
        })
            .option("workers", {
            type: "string",
            default: "0",
